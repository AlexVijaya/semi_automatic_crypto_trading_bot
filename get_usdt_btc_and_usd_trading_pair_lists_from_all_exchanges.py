...
def get_USDT_and_BTC_trading_pairs_from_all_exchanges():
    ...
    global list_of_all_usd_pairs_from_all_exchanges_without_duplicates
    global flattened_list_of_all_btc_pairs_from_all_exchanges
    global flattened_list_of_all_usdt_pairs_from_all_exchanges
    global flattened_list_of_all_usd_pairs_from_all_exchanges
    ...
    list_of_all_usd_pairs_from_all_exchanges = []
    ...
    for exchange in list_of_all_exchanges:
        ...
        try:
            ...
            list_of_all_usd_pairs_from_all_exchanges.append ( usd_pairs_list )
    ...
    flattened_list_of_all_usd_pairs_from_all_exchanges = \
        flatten ( list_of_all_usd_pairs_from_all_exchanges )
    ...
    list_of_all_usd_pairs_from_all_exchanges_without_duplicates = \
        list ( dict.fromkeys ( flatten ( list_of_all_usd_pairs_from_all_exchanges ) ) )
    ...
    print('\nnumber_of_all_usdt_pairs_from_all_exchanges_without_duplicates=' ,
            len ( list_of_all_usdt_pairs_from_all_exchanges_without_duplicates ))
    print ( '\nnumber_of_all_usd_pairs_from_all_exchanges_without_duplicates=' ,
            len ( list_of_all_usd_pairs_from_all_exchanges_without_duplicates ) )
    #time.sleep(5)
