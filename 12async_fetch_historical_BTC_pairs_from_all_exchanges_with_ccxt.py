...
def fetch_historical_btc_pairs_asynchronously(exchanges_list):
    ...
    path_to_async_ohlcv_db=os.path.join ( os.getcwd () ,
                                         ...
                                         "12async_all_exchanges_multiple_tables_historical_data_for_btc_trading_pairs.db" )
...
if __name__=="__main__":
    ...
    try:
        fetch_historical_btc_pairs_asynchronously(exchange_list[111:how_many_exchanges])
    except Exception as e:
        print ( e )
        traceback.print_exc ()
