...
def plot_ohlcv_chart_with_price_approaching_mirror_levels ():
    ...
    list_of_ohlcv_with_recent_mirror_highs_and_lows=cursor.fetchall()
    ...
    for table_name in list_of_ohlcv_with_recent_mirror_highs_and_lows:
        ...
        table_name_list_from_approaching_db.append(table_name[0])
    ...
    folder_to_be_deleted = os.path.join ( os.getcwd () ,
                                          'datasets' ,
                                          'plots' ,
                                          'price_approaching_mirror_level_crypto_exchange_plots' )
