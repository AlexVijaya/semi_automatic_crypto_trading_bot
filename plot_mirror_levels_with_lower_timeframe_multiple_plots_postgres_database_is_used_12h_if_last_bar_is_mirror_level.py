...
def plot_ohlcv_chart_with_mirror_levels_from_given_exchange (lower_timeframe_for_mirror_level_rebound_trading='1h'):
    ...
    connection_to_usdt_trading_pairs_ohlcv_ready_for_rebound_lower_period_timeframe = \
        connect_to_postres_db (
            f"ohlcv_with_lower_tfs_for_each_mirror_level_12h_only_last_bar" )


    mirror_levels_df = pd.read_sql ( f'''select * from mirror_levels_without_duplicates_last_bar_included ;''' ,
    ...
    for row_number in range(0,len(mirror_levels_df)):
        ...
        list_of_lower_timeframes=['1h','4h','6h','8h']
        ...
        try:
            ...
            try:
                ...
                subplot_title_list=['12h','12h_in_greater_detail']
                ...
                try:
                    ...
                    try:
                        ...
                        for row_number_for_inner_loop in range(0,len(historical_data_for_usdt_trading_pair_df)):
                            if historical_data_for_usdt_trading_pair_df["low"].iat[row_number_for_inner_loop]==mirror_level:
                                ...
                                how_many_last_rows_to_plot=len(historical_data_for_usdt_trading_pair_df)-row_number_for_inner_loop+10
                                break
                        ...
                        #     print ( "how_many_last_rows_to_plot_before=" , how_many_last_rows_to_plot )
                        #     first_valid_index_of_high = \
                        #         historical_data_for_usdt_trading_pair_df[
                        #             "mirror_level_of_another_high"].first_valid_index ()
                        #     if first_valid_index_of_high:
                        #         last_rows_for_calculation=len ( historical_data_for_usdt_trading_pair_df )-\
                        #                                   first_valid_index_of_high+10
                        #         print ( "first_valid_index_of_high" )
                        #         print ( first_valid_index_of_high )
                        #         if last_rows_for_calculation>how_many_last_rows_to_plot:
                        #
                        #             how_many_last_rows_to_plot=last_rows_for_calculation
                        #             print ( "last_rows_for_calculation_high is leftmost" )
                        #             print ( last_rows_for_calculation )
                        #             print ( "how_many_last_rows_to_plot_after" )
                        #             print ( how_many_last_rows_to_plot )
                        # else:
                        #     row_for_plotting_start = row_number_of_low - 20
                        #     how_many_last_rows_to_plot = \
                        #         len ( historical_data_for_usdt_trading_pair_df ) - row_for_plotting_start
                        #     print ( "how_many_last_rows_to_plot_before=" , how_many_last_rows_to_plot )
                        #     first_valid_index_of_low = \
                        #         historical_data_for_usdt_trading_pair_df[
                        #             "mirror_level_of_another_low"].first_valid_index ()
                        #     print ( "first_valid_index_of_low" )
                        #     print ( first_valid_index_of_low )
                        #     if first_valid_index_of_low:
                        #         last_rows_for_calculation = len (
                        #             historical_data_for_usdt_trading_pair_df ) - first_valid_index_of_low + 10
                        #         print("type(first_valid_index_of_low)")
                        #         print ( type ( first_valid_index_of_low ) )
                        #         if last_rows_for_calculation > how_many_last_rows_to_plot:
                        #             print ( "last_rows_for_calculation_low is leftmost" )
                        #             print ( last_rows_for_calculation )
                        #
                        #             how_many_last_rows_to_plot = last_rows_for_calculation
                        #             print ( "how_many_last_rows_to_plot_after" )
                        ...
                        print("how_many_last_rows_to_plot")
                        print ( how_many_last_rows_to_plot )
                        print("len(historical_data_for_usdt_trading_pair_df['open_time'])")
                        print ( len ( historical_data_for_usdt_trading_pair_df[
                                          'open_time'] ) )
                    ...
                    try:
                        if len(open_time_of_another_high_list)>0:
                            first_valid_index_of_high=\
                                historical_data_for_usdt_trading_pair_df["mirror_level_of_another_high"].first_valid_index()
                            # print('historical_data_for_usdt_trading_pair_df["mirror_level_of_another_high"]')
                            # print(historical_data_for_usdt_trading_pair_df["mirror_level_of_another_high"].to_string())
                            # print ( 'historical_data_for_usdt_trading_pair_df["open_time_of_another_high"]' )
                            # print (
                            #     historical_data_for_usdt_trading_pair_df["open_time_of_another_high"].to_string () )
                            # print("first_valid_index_of_high")
                            # print ( first_valid_index_of_high )
                            # print("len(open_time_of_another_high_list)")
                            # print ( len ( open_time_of_another_high_list ) )
                            # print ( "open_time_of_another_high_list"  )
                            # print ( open_time_of_another_high_list )
                            # time.sleep(30)
                    ...
                    try:
                        if len(open_time_of_another_low_list)>0:
                            # print('historical_data_for_usdt_trading_pair_df["mirror_level_of_another_low"]')
                            # print ( historical_data_for_usdt_trading_pair_df["mirror_level_of_another_low"].to_string() )
                            # time.sleep(30)
