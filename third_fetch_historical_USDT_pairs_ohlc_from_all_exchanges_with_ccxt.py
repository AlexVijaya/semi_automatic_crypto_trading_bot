...
def get_BTC_and_USDT_pair_ohlcv_from_exchanges():
    #global flattened_list_of_all_btc_pairs_from_all_exchanges
    # global flattened_list_of_all_usdt_pairs_from_all_exchanges
    ...
    list_of_all_exchanges = ['aax']
    usdt_pairs_list=['ADA/USDC', 'ATOM/USDC', 'BNB/USDC', 'BTC/USD:BTC',
                     'BTC/USDC', 'DOT/USDC', 'EOS/USDC', 'ETH/USD:BTC',
                     'ETH/USDC', 'LINK/USDC', 'LTC/USDC', 'SOL/USDC',
                     'TRX/USDC', 'ZEC/USDC']
    for exchange in list_of_all_exchanges:
        ...
        try:
            ...
            for usdt_pair in usdt_pairs_list:
                try:
                    ...
                    # data_df.to_sql ( f"usdt_pairs" ,
                    #                  connection_to_usdt_trading_pairs_ohlcv ,
                    #                  if_exists = 'append' )
                    #

                except Exception as e:
                    print ( f'problem with exchange {usdt_pair}\n' , e )
                    traceback.print_exc ()
                    continue
