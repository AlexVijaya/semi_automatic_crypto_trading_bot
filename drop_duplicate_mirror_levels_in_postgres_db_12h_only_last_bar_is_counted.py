...
def drop_duplicates_in_db():
    ...
    mirror_levels_df=pd.read_sql_query("select * from mirror_levels_calculated_separately_last_bar_included",
    ...
    mirror_levels_df.to_sql("mirror_levels_without_duplicates_last_bar_included",
                            connection_to_btc_and_usdt_trading_pairs,
                            if_exists ='replace')
