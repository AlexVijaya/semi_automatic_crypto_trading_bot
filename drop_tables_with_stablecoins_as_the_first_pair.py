...
def drop_tables_in_db_if_first_pair_is_stablecoin(database_with_stablecoin_names_as_first_name=
                                                  "async_ohlcv_data_for_usdt_trading_pairs"):
    start = time.perf_counter ()
    current_timestamp = time.time ()

    engine_for_usdt_trading_pairs_daily_ohlcv , connection_to_usdt_trading_pairs_daily_ohlcv = \
        connect_to_postres_db (database_with_stablecoin_names_as_first_name )
...
if __name__=="__main__":
    database_with_stablecoin_names_as_first_name ="async_ohlcv_data_for_usdt_trading_pairs"
