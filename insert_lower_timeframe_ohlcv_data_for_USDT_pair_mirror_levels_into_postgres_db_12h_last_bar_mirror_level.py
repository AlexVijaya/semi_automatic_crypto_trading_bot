...
def find_mirror_levels_in_database(lower_timeframe_for_mirror_level_rebound_trading):
    ...
    try:
        mirror_df = \
            pd.read_sql_query ( f'''select * from mirror_levels_without_duplicates_last_bar_included''' ,
                                connection_to_btc_and_usdt_trading_pairs )
        print("mirror_df\n",mirror_df.to_string())
