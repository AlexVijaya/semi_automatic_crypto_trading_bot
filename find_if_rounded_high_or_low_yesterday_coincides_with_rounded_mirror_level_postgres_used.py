...
def find_mirror_levels_in_database():
    ...
    try:
        drop_table ( "usdtpairs_with_recent_rounded_low_or_high_equal_to_mirror_level" ,
    ...
    try:
        mirror_df = \
            pd.read_sql_query ( f'''select * from rounded_mirror_levels_without_duplicates''' ,
        ...
        for row in range(0,len(mirror_df)):
            try:
                ...
                #time.sleep(1000)
                usdt_pair_name_and_exchange_df.to_sql ( '''usdtpairs_with_recent_rounded_low_or_high_equal_to_mirror_level''' ,
                                 connection_to_btc_and_usdt_trading_pairs ,
                                 if_exists = "append" )
        ...
        engine_for_usdt_trading_pairs_ohlcv_yesterday_high_or_low_db , connection_to_usdt_trading_pairs_ohlcv_yesterday_high_or_low = \
            connect_to_postres_db ( "rounded_ohlcv_tables_yesterdays_h_or_l_equal_to_mirror_level"  )
