...
def find_mirror_levels_in_database():
    ...
    path_to_ohlcv_db_with_yesterday_high_or_low = os.path.join ( os.getcwd () ,
                                                                 "datasets" ,
                                                                 "sql_databases" ,
    ...
    create_empty_database ( path_to_ohlcv_db_with_yesterday_high_or_low )

    connection_to_usdt_trading_pairs_ohlcv_yesterday_high_or_low = \
        sqlite3.connect ( path_to_ohlcv_db_with_yesterday_high_or_low )
